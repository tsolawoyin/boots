...
const leaderBoard = [
  {
    ...
    name: "Seun",
    chm: [
      70,60,95, 85, 87.5, 45, 100, 0, 45, 37.5, 75, 45, 45, 10, 23, 32.5, 67.5, 50, 25,
      32.5, 17.5, 57.5, 47.5, 92.5,
    ], // an object will help me track their progress in each topic
    bio: [45,85,100, 94.44, 80.56, 0],
    eng: [
      80,55,100, 100, 52.5, 65.0, 100, 80, 55, 100, 105, 100, 2.5, -2.5, 100, 30, 95, 72.5,
      -12.5, 20,
    ],
    calcScore() {
      return (
  ...
  },
  {
    ...
    name: "Ayodeji",
    chm: [
      97.5,80,65, 62.5, 45, 90, 22.5, 10, 50, 65, 57.5, 60, -5.0, 31, 42.5, 62, 5, 27.5,
      22.5, 70, 22.5, 72.5, 90, 62.5,
    ],
    bio: [-5,100,70, 35, 89, 88.9],
    eng: [
      62.5,60, 55, 60, 60, 52.5, 67, 52.5, 30, 75, 80, 15, 10, 40, 30, 0, 52.5, 5, 10,
    ],
    calcScore() {
      return (
        this.chm.reduce((a, e) => a + e) +
  ...
  },
  {
    ...
    name: "Tosin",
    chm: [
      95,100,90, 62.5, 60, 85, 85, 32.5, 80, 52.5, 67.5, 50, 60, 50, 23, 65, 90, 55, 45,
      50, 17.5, 90, 40, 67.5,
    ],
    bio: [100,100,30, 100, 44.44, 100],
    eng: [
      70,35, 85, 95, 100, 95, 85, 75, 100, 115, 100, 35, 65, 100, 95, 62.5, 72.5, 55,
      32.5,
    ],
    calcScore() {
      return (
