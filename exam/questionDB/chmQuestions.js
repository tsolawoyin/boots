...
let chemistryQuestions = [
    ...
    },
    {
        ...
        questions: [
            {
                id: 1,
                question: "Which of the following statements concerning the three types of subatomic particles is correct?",
                options: [
            ...
            {
                id: 2,
                question: "Which of the following statements concerning a neutron is correct?",
                options: [
            ...
            {
                id: 3,
                question: "How many electrons are required to equal the mass of one proton?",
                options: [
                    "1", 
                    "23",
                    "about 1800",
            ...
            {
                id: 4,
                question: "Which of the following statements concerning an atom's nucleus is correct",
                options: [
            ...
            {
                id: 6,
                question: "The atomic number for an atom containing 10 neutrons and 8 protons is",
                options: [
                    "8",
                    '10',
                    "18",
            ...
            {
                id: 7,
                question: "An atom that has an atomic number of 11 and a mass number of 23 contains how many neutrons?",
                options: [
                    "11",
                    '12',
                    "23",
            ...
            {
                id: 8,
                question: `How many electrons are present in an atom of ${isotope("31","15","P")}?`,
                options: [
                    "15",
                    '16',
                    "31",
            ...
            {
                id: 10,
                question: `Which of the following response is correct for ${isotope("27", "14", "Si")}?`,
                options: [
            ...
            {
                id: 29,
                question: `How many electrons are present in atoms of the element whose electron configuration is ${eConfig("1s",2,"2s",2,"2p",6,"3s",1)}?`,
                options: [
                    `four`,
                    `eight`,
                    `eleven`,
            ...
            {
                id: 31,
                question: `Which of the following statement is consistent with the electron configuration ${eConfig("1s",2,"2s",2,"2p",3)}`,
                options: [
            ...
            {
                id: 32,
                question: `How many different orbitals contain electrons in atoms with the electron configuration ${eConfig("1s",2,"2s",2,"2p",3)}`,
                options: [
                    `three`,
                    `four`,
                    `six`,
            ...
            {
                id: 33,
                question: `How many unpaired electrons are present in the orbital diagram for an atom whose electron configuration is ${eConfig("1s",2,"2s",2,"2p",4)}`,
                options: [
                    `none`,
                    `two`,
                    `four`,
            ...
            {
                id: 36,
                question: `Which of the following elements is located in the ${ion("p",4)} column of the periodic table?`,
                options: [
                    `${isotope("","15","P")}`,
                    `${isotope("","34","Se")}`,
                    `${isotope("","53","I")}`,
            ...
            },
            {
                ...
                options: [
                    ...
                    `${eConfig("1s",2,"2s",2,"2p",1)} and ${eConfig("1s",2,"2s",2,"2p",6,"3s",1)}`,
                    `${eConfig("1s",2,"2s",2)} and ${eConfig("1s",2,"2s",2,"2p",6,"3s",2)}`,
                    "no corrrect response",
                ],
                ans: "C",
            },
            ...
            },
            {
                ...
                options: [
                    ...
                    `noble-gas element - electron configuration ends in ${eConfig("p",5)} or ${eConfig("p",6)}`,
                    "no corrrect response",
                ],
                ans: "C",
            },
    ...
    },
    {
        ...
        "questions": [
            {
                id: 1,
                question: "When air which contains the gases oxygen, nitrogen, carbon dioxide, water vapor and the rare gases is passed through alkaline pyrogallol and then over quicklime, the only gases left are",
                options: [
            ...
            {
                id: 2,
                question: "A gas jar was inverted over burning yellow phosphorus floating over water in a beaker. After burning, the water level was found to rise in the gas jar. The water level rises because",
                options: [
            ...
            {
                id: 3,
                question: "When a piece of charcoal enclosed in a cylinder containing air is ignited.",
                options: [
            ...
            {
                id: 5,
                question: "The nitrogen gas obtained by burning an excess of phosphorus in air has a density higher than the nitrogen from nitrogen compounds because the nitrogen from air is contaminated with",
                options: [
            ...
            {
                id: 6,
                question: "When air is passed through alkaline pyrogallol and then over quicklime, the only gases left are",
                options: [
            ...
            {
                id: 7,
                question: `In what respect will two dry samples of nitrogen gas differ from each other if sample 1 is prepared by completely removing ${formula("CO",2)} and ${formula("O",2)} is prepared by passing purified nitrogen(I) oxide over heated copper? Sample 1 is`,
                options: [
                    "purer than sample 2", 
            ...
            {
                id: 8,
                question: `The approximate volume of air containing ${exp(3)}cm<sup>3</sup> of oxygen is`,
                options: [
                    "20cm<sup>3</sup>", 
                    "25cm<sup>3</sup>", 
                    "50cm<sup>3</sup>", 
            ...
            },
            {
                ...
                options: [
                    ...
                    `${formula("CO",2)}, ${formula("NH",3)} and ${formula("H",2,"S")}`, 
            ...
            },
            {
                ...
                options: [
                    `${formula("CO",2)}, ${formula("SO",3)}, and ${formula("N",2,"O")}`, 
                    `${formula("CO",2)}, ${formula("CO")}, and ${formula("N",2,"O")}`, 
                    `${formula("SO",2)}, ${formula("CO")}, and ${formula("N","O",2)}`, 
                    `${formula("PH",3)}, ${formula("H",2,"O")}, and ${formula("C","O","2")}`,
                ],
                ans: "C",
            },
            {
            ...
            {
                id: 22,
                question: `Excess phosphorus was burnt in gas jar and the residual gas passed successively over concentrated KOH solution and concentrated ${formula("H",2,"SO",4)} before being collected in a flask. The gases collected are`,
                options: [
